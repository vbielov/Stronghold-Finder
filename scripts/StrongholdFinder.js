...
function GetSlope(minecraftDegree) {
...
function GetEndEyeRays(inputData) {
...
export function Find(inputData) {
...
export function Test() {
    ...
    const rightSolution = new Vector(192, 2032);
    var testedSolution = Find(input).strongholdPos;
    if (Vector.Distance(rightSolution, testedSolution) < 100)
        return true;
...
export function FindAll(inputData) {
    var strongholds = [];
